...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--wpae5e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--wpae5e.containers.anotherwebservice.com/
...
```
git clone git@github.com:ParvathiRNair/container--wpae5e.git
cd container--wpae5e
```
...
```
docker attach container--wpae5e
```
